...
internal sealed class DataReportCommand : HttpCommandBase
{
    ...
    internal static void ShowHelp()
    {
        ...
        ConsoleTool.DisplayTextLine("          1. output file [OutputFile]");
        ConsoleTool.DisplayTextLine("          2. tenant identifier [Tenant]");
        ConsoleTool.DisplayTextLine("          3. user identifier [User]");
        ConsoleTool.DisplayTextLine("          4. regulation name [Regulation]");
        ConsoleTool.DisplayTextLine("          5. report name [Report]");
        ConsoleTool.DisplayTextLine("          6. report parameter file with a json string/string dictionary (optional) [ParametersFile]");
        ConsoleTool.DisplayTextLine("          7. report culture [Culture]");
