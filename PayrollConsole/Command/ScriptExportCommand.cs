...
internal sealed class ScriptExportCommand : HttpCommandBase
{
    ...
    internal static void ShowHelp()
    {
        ...
        ConsoleTool.DisplayTextLine("          1. target folder [TargetFolder]");
        ConsoleTool.DisplayTextLine("          2. tenant identifier [Tenant]");
        ConsoleTool.DisplayTextLine("          3. user identifier [User]");
        ConsoleTool.DisplayTextLine("          4. employee identifier [Employee]");
        ConsoleTool.DisplayTextLine("          5. payroll name [Payroll]");
        ConsoleTool.DisplayTextLine("          6. regulation name [Regulation]");
        ConsoleTool.DisplayTextLine("          7. namespace [Namespace]");
